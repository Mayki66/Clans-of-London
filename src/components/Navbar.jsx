        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <div className="hidden sm:block">
              <div className="flex items-center space-x-1.5">
                <span className="font-gothic font-extrabold text-base lg:text-lg tracking-wider text-gray-100 group-hover:text-amber-400 transition-colors">
          ...
          <nav className="flex items-center space-x-1 sm:space-x-1.5 overflow-x-auto py-1">
            ...
            <button
              ...
              className={`flex items-center space-x-1.5 px-2.5 sm:px-3 py-2 rounded-xl text-xs font-gothic font-bold transition-all ${
            ...
            >
              ...
              <span className="hidden sm:inline">{t?.nav?.deckbuilder || "Deck Builder"}</span>
            ...
            >
              ...
              <span className="hidden md:inline">{t?.nav?.database || "Base de Cartes"}</span>
            </button>
            ...
            >
              ...
              <span className="hidden lg:inline">{t?.nav?.metadecks || "Decks Méta"}</span>
            </button>
            ...
            >
              ...
              <span className="hidden md:inline">{t?.nav?.rules || "Règles"}</span>
            </button>
          ...
          <div className="flex items-center space-x-1 p-1 rounded-xl bg-[#141824] border border-white/10 text-xs font-bold font-mono ml-2 flex-shrink-0">
            <button
