...
export default function DeckStats({ deckCards }) {
  ...
  if (totalCount === 0) {
    return (
      <div className="glass-panel rounded-2xl p-6 text-center border border-white/10 text-gray-500">
        ...
        <p className="text-sm font-gothic">Ajoutez des cartes à votre deck pour afficher les analyses et courbes.</p>
      </div>
    );
  }
  ...
  const dominantClan = Object.entries(clanCounts).sort((a, b) => b[1] - a[1])[0] || ['Inconnu', 0];
  const dominantArch = Object.entries(archetypeCounts).sort((a, b) => b[1] - a[1])[0] || ['Neutre', 0];
  ...
  return (
    <div className="glass-panel rounded-2xl p-5 space-y-5 border border-white/10 shadow-2xl">
      ...
      {/* Blood Mana Curve Histogram (Draftsim Style) */}
      <div className="space-y-2 pt-2 border-t border-white/10">
        <div className="flex items-center justify-between text-xs text-gray-300 font-gothic font-semibold uppercase tracking-wider">
          <span className="flex items-center space-x-1.5">
            ...
            <span>Courbe de Coût en Sang</span>
          </span>
          <span className="text-[11px] font-mono text-gray-500">Distribution par Coût</span>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-white/10">
        ...
        <div className="space-y-2">
          <h4 className="text-xs font-gothic font-semibold uppercase tracking-wider text-gray-300 flex items-center space-x-1.5">
            ...
            <span>Répartition par Clan</span>
          </h4>
        ...
        <div className="space-y-2">
          <h4 className="text-xs font-gothic font-semibold uppercase tracking-wider text-gray-300 flex items-center space-x-1.5">
            ...
            <span>Synergies d'Archétypes</span>
          </h4>
          <div className="space-y-1.5 bg-[#090b10] p-3 rounded-xl border border-white/5 max-h-40 overflow-y-auto">
